...
public class TinyDB {
    ...
    public ArrayList<Phones> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Phones> playerList =  new ArrayList<Phones>();

        for(String jObjString : objStrings){
            Phones player  = gson.fromJson(jObjString, Phones.class);
    ...
    public void putListObject(String key, ArrayList<Phones> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Phones player: playerList){
